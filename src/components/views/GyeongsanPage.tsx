...
interface GyeongsanPageProps {
  regionName?: string;
  regionDescription?: string;
}

export default function GyeongsanPage({ regionName = '경산', regionDescription }: GyeongsanPageProps) {
  ...
  const galleryImages = [
    ...
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 작업 현장 - 건설 현장'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 자재 운반 작업 - 석재 운송'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 대형 석재 운반 작업'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 작업 - 중량물 운반'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 산악 지역 작업 현장'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 크레인 타워 작업'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 건설 현장 자재 운반'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 대형 목재 운반 작업'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 도시 지역 크레인 작업'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 파이프 운반 작업'
    },
    {
      src: 'https://www.daehancargocrane.com/android-icon-192x192.png',
      alt: '경산 크레인 실내 작업 현장'
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[100rem] mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-heading font-bold mb-6">{regionName}</h2>
