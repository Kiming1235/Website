...
export default function DaeguPage({
  ...
  // 경주 지역 갤러리 (홈페이지와 동일하게 설정 - 24개 이미지)
  const galleryImages = [
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 - 건설 현장' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 1' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 2' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 3' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 4' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 5' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 6' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 7' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 8' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 9' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 10' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 현장 - 건설 현장' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 자재 운반 작업 - 석재 운송' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 대형 석재 운반 작업' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 - 중량물 운반' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 산악 지역 작업 현장' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 타워 작업' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 건설 현장 자재 운반' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 대형 목재 운반 작업' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 도시 지역 크레인 작업' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 파이프 운반 작업' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 실내 작업 현장' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 산악 지역 중량물 운반' },
    { src: 'https://www.daehancargocrane.com/android-icon-192x192.png', alt: '경주 크레인 작업 - 정밀 운반' }
  ];
